...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden">
      {/* -- NAV -- */}
      <nav className="fixed top-0 w-full z-50 backdrop-blur-xl bg-white/80 border-b border-slate-200 transition-all">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 h-20">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="text-xl font-bold tracking-tight text-slate-900">VerifyIQ</span>
          </Link>
          <div className="flex items-center gap-6">
            ...
            <Link
              href="/auth/signup"
              className="text-sm font-semibold px-6 py-2.5 rounded-full bg-slate-900 text-white hover:bg-slate-700 transition shadow-lg"
            >
              Get Started
            </Link>
          </div>
